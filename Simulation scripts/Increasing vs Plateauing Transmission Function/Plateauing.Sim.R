...
coital_freq_vec  <- c(0.05,0.075,0.10,0.125)

#output name
modname_vec=c("conc0","conc5","conc10","conc15","conc20")
modname_vec2=c("msa0.05","msa0.075","msa0.10","msa0.125")
...
{  
  ...
  load(file.path(outpath,paste("evo_nw_plateauing_",modname,modname2,".RDATA",sep="")))
